...
//	int UpdateFireRisk(int, int);				// Update fire risk, fire intensity based on new fine and coarse fuels
	...
	int setDTN(int*, int, int);					// set the dead tree number into PDP houbin 1/4/2017

	int getDTN(int, int, int);

	int setDTNBIO(float*, int, int);			// set the dead tree biomass into PDP houbin 2/19/2017

	int setDTNBA(float*, int, int);				//set the dead tree basal area into PDP houbin 2/22/2017
