...
//	printf("fuelmanage-> processEvents");
	...
	if (pPDP->TrackFlag == 1)
	{
		for (int iii = 0; iii < fuelsites.rows - 1; iii++)
		{
			for (int jjj = 0; jjj < fuelsites.cols - 1; jjj++)
			{
				for (int kkk = 0; kkk < pPDP->specnum; kkk++)
				{
					pPDP->cDeadTreeNum[iii][jjj][kkk] = 0;
					pPDP->cDeadTreeBA[iii][jjj][kkk] = 0;
					pPDP->cDeadTreeBio[iii][jjj][kkk] = 0;
				}
			}
		}
		...
		for (int iii = 0; iii < fuelsites.rows - 1; iii++)
		{
			for (int jjj = 0; jjj < fuelsites.cols - 1; jjj++)
			{
				for (int kkk = 0; kkk < pPDP->interval_number*pPDP->specnum; kkk++)
				{
					pPDP->cDeadTreeNum_spec_agerange[iii][jjj][kkk] = 0;
					pPDP->cDeadTreeBio_spec_agerange[iii][jjj][kkk] = 0;
					pPDP->cDeadTreeBA_spec_agerange[iii][jjj][kkk] = 0;
				}
			}
		}
	}
	...
	/*for (int iii = 0; iii < fuelsites.rows-1; iii++)
	{
		for (int jjj = 0; jjj < fuelsites.cols-1; jjj++)
		{
			for (int kkk = 0; kkk < pPDP->specnum; kkk++)
			{
				if (pPDP->cDeadTreeNum[iii][jjj][kkk] != 0)
				{
					printf("fuel catched%d(%d,%d)%d ", kkk ,iii, jjj, pPDP->cDeadTreeNum[iii][jjj][kkk]);
				}
			}
		}
	}*/
